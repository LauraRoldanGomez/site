---
title: "R training - Session 3"
subtitle: 'Manipulating and Plotting Data'
...
1. [_Previously on R Workshops_](#previously): topics covered in last session
2. [Learning Objectives](#LO)
3. [Set Up](#setup)
4. [Data](#data)
5. [Topics](#topics)
    + 5.1. [Data exploration](#deasi)
      - Subsetting
      - Matching
      - Merging and binding
      - [Tasks](#tasks1)
    + 5.2. [Data manipulation](#dm)
      - Paste
      - Renaming columns and rows
      - Adding and removing variables
      - Sequence
      - [Tasks](#tasks2)
    + 5.3. [Basic visualisations](#bv)
      - Types of plots
      - Plots on plots
      - Plot additions
      - Margins 
      ...
      - [Tasks](#tasks3)
6. [_Next on R Workshops_](#next): topics covered in next workshop
7. [Resources](#res)
...
# <a id="previously"></a>1. _Previously on R Workshops_: topics covered in last session

In Session 2 - Datatypes and Structures, we...
...
# <a id="LO"></a>2. Learning Objectives
...
# 5. <a id="topics"></a>Topics

## <a id="deasi"></a>3.1 Data exploration
...
## <a id="dm"></a>5.2 Data manipulation
